...
describe('Transaction tools', () => {
  ...
  it('should convert Date and Mani from the db', () => {
    ...
    expect(fromDb({
      ...
      .toEqual({
        ...
        balance: mani(2.35),
        income: mani(3) })
    expect(fromDb([{ balance: '1,00 ɱ' }, { income: '2,00 ɱ' }]))
      .toEqual([{ balance: mani(1) }, { income: mani(2) }])
  })

  it('should destructure payloads', () => {
    const dateISO = '2021-01-28T00:00:00.000Z'
    const date = new Date(dateISO)
    expect(destructurePath(
      `/ledger1/000000000013/nextuida`))
      .toEqual({
        ledger: 'ledger1',
        sequence: 13,
        uid: 'nextuida'
  ...
  it('should convert payloads to entries', () => {
    const dateISO = '2021-01-28T00:00:00.000Z'
    const date = new Date(dateISO)
    const payload = '/2021-01-28T00:00:00.000Z/from/ledger1/000000000013/nextuida/to/ledger2/000000000024/nextuidb/-7,35 ɱ'
    expect(toEntry(payload))
      .toEqual({
        date,
        ledger: 'ledger1',
        entry: 'pending',
  ...
  it('should flip payloads', () => {
    expect(flip(
      '/2021-01-28T00:00:00.000Z/from/ledger1/000000000013/nextuida/to/ledger2/000000000024/nextuidb/-7,35 ɱ')).toEqual(
