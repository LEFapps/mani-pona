    ...
    <>
      <Card>
        ...
        <Text style={globalStyles.paragraph}>
          ...
          een samenwerking tussen Howest Netwerkeconomie en Lichtervelde Lokaal
          vzw (ON 0746.998.186){'\n'}
          {'\n'}
  ...
  return (
    <ScrollView style={globalStyles.main}>
      <View style={{ marginBottom: 10 }}>
        {/* Extra info about project can be added here. Make changes to the content as needed in Content (above) and uncomment the following line: */}
        {/* <Content /> */}
        {/* FAQ */}
        <Faq />
      </View>
